...
export interface DigitalContract {
  ...
  terms?: string;
  status: 'OPEN' | 'BID_PLACED' | 'ACCEPTED_IN_ESCROW' | 'IN_TRANSIT' | 'DELIVERED' | 'DELIVERY_CONFIRMED' | 'FULFILLED' | 'COMPLETED' | 'CANCELLED';
  ...
  escrow_status?: 'NOT_FUNDED' | 'PENDING_ADMIN_APPROVAL' | 'HELD_IN_ESCROW' | 'RELEASED_TO_FARMER' | 'REFUNDED_TO_BUYER';
  admin_approval_status?: 'PENDING' | 'APPROVED' | 'REJECTED' | 'NOT_APPLICABLE';
  ...
  escrow_payment_mode?: 'SIMULATED_SANDBOX' | 'UPI_QR' | 'BANK_NEFT';
  escrow_utr?: string;
  escrow_deposited_at?: string;
